...
from Database.SQLConnect import create_connection,execute_read_query,execute_query
...
if __name__ == "__main__":
    ...
    Notification.insert_notification_for_all_users("Test notification message for all users.")
